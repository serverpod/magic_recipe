...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == List<(_i4.AuthUserModel, _i4.UserProfileModel)>) {
      return (data as List)
              .map(
                (e) =>
                    deserialize<(_i4.AuthUserModel, _i4.UserProfileModel)>(e),
              )
              .toList()
          as T;
    }
    if (t == _i1.getType<(_i4.AuthUserModel, _i4.UserProfileModel)>()) {
      return (
            deserialize<_i4.AuthUserModel>(((data as Map)['p'] as List)[0]),
            deserialize<_i4.UserProfileModel>(data['p'][1]),
          )
          as T;
    }
    if (t == _i1.getType<(_i4.AuthUserModel, _i4.UserProfileModel)>()) {
