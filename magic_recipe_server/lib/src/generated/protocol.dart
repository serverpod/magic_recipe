...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t ==
        List<
          ({_i5.AuthUserModel authUser, _i5.UserProfileModel userProfile})
        >) {
      return (data as List)
              .map(
                (e) =>
                    deserialize<
                      ({
                        _i5.AuthUserModel authUser,
                        _i5.UserProfileModel userProfile,
                      })
                    >(e),
              )
              .toList()
    ...
    if (t ==
        _i1
            ...
            >()) {
      return (
            authUser: deserialize<_i5.AuthUserModel>(
              ((data as Map)['n'] as Map)['authUser'],
            ),
            userProfile: deserialize<_i5.UserProfileModel>(
              data['n']['userProfile'],
            ),
          )
          as T;
    ...
    if (t == List<_i5.AuthUserModel>) {
      return (data as List)
              .map((e) => deserialize<_i5.AuthUserModel>(e))
              .toList()
          as T;
    }
...
Map<String, dynamic>? mapRecordToJson(Record? record) {
  ...
  if (record
      is ({_i5.AuthUserModel authUser, _i5.UserProfileModel userProfile})) {
    return {
      "n": {
