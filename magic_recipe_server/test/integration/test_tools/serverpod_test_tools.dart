...
class TestEndpoints {
  ...
  late final _AuthAdminEndpoint authAdmin;
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue = await _localCallContext.method
            ...
            .then(
              (record) => _i5.Protocol()
                  .deserialize<List<(_i4.AuthUserModel, _i4.UserProfileModel)>>(
                    record,
                  ),
            );
        return _localReturnValue;
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i4.AuthUserModel>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _RecipesEndpoint {
  ...
  _i3.Stream<_i7.Recipe> generateRecipeStream(
    _i1.TestSessionBuilder sessionBuilder,
    String ingredients, [
    String? imagePath,
  ]) {
    var _localTestStreamManager = _i1.TestStreamManager<_i7.Recipe>();
  ...
  _i3.Future<_i7.Recipe> generateRecipe(
    _i1.TestSessionBuilder sessionBuilder,
    String ingredients, [
    String? imagePath,
  ]) async {
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue = await _localCallContext.method
            ...
            .then(
              (record) => _i5.Protocol().deserialize<(String?, String)>(record),
            );
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
