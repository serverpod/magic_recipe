...
## Add passwords.yaml file

Adding the passwords configuration file for API keys
...
## Update RecipesEndpoint to use AI service

Refactoring the endpoint to use a service abstraction for AI-powered recipe generation
